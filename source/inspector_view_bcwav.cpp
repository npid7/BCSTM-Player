...
template <typename T>
static std::string _vStr(const T& v) {
  return std::format("{} -> {}", _Str(v), (PD::u32)v);
}

/** Type Value String like Endianness2String */
template <typename T>
static std::string _fStr(const T& v, std::function<std::string(const T& v)> f) {
 ...
 */
template <typename T>
static std::string _bStr(const T& v) {
  return std::format("{} -> {}", _Str(v), PD::Strings::FormatBytes(v));
}

/** true false str */
template <typename T>
static std::string _tStr(const T& v) {
  return std::format("{} -> {}", _Str(v), (bool)v);
}

/** Wrapper for InspectorBCWAV::MakeEntry */
static InspectorBCWAV::TabEntry::Ref _me(const std::string& f,
                                         const std::string& e) {
  return InspectorBCWAV::MakeEntry(f, e);
}

static InspectorBCWAV::TabEntry::Ref MakeRef(ctrff::BCWAV::Reference& b,
                                             const std::string& name = "") {
  auto e = InspectorBCWAV::TabEntry::New();
  std::vector<InspectorBCWAV::TabEntry::Ref> Lst;
  Lst.push_back(_me("TypeID", _fStr<ctrff::BCWAV::ReferenceTypes>(
                                  (ctrff::BCWAV::ReferenceTypes)b.TypeID,
                                  ctrff::BCWAV::ReferenceType2String)));
...
static InspectorBCWAV::TabEntry::Ref MakeSizedRef(
    ctrff::BCWAV::SizedReference& b, const std::string& name = "") {
  auto e = InspectorBCWAV::TabEntry::New();
  std::vector<InspectorBCWAV::TabEntry::Ref> Lst;
...
static InspectorBCWAV::TabEntry::Ref MakeRefListVec(
    std::vector<ctrff::BCWAV::Reference>& b, const std::string& name = "") {
  auto e = InspectorBCWAV::TabEntry::New();
  std::vector<InspectorBCWAV::TabEntry::Ref> Lst;
...
static InspectorBCWAV::TabEntry::Ref MakeRefTable(
    ctrff::BCWAV::ReferenceTable& b, const std::string& name = "") {
  auto e = InspectorBCWAV::TabEntry::New();
  std::vector<InspectorBCWAV::TabEntry::Ref> Lst;
...
static InspectorBCWAV::TabEntry::Ref MakeBlockHdr(
    ctrff::BCWAV::BlockHeader& b, const std::string& name = "") {
  auto e = InspectorBCWAV::TabEntry::New();
  std::vector<InspectorBCWAV::TabEntry::Ref> Lst;
...
static InspectorBCWAV::TabEntry::Ref MakeInfoBlock(
    ctrff::BCWAV::InfoBlock& b, const std::string& name = "") {
  auto e = InspectorBCWAV::TabEntry::New();
  std::vector<InspectorBCWAV::TabEntry::Ref> Lst;
  Lst.push_back(MakeBlockHdr(b.Header));
  Lst.push_back(_me("Encoding", _fStr<ctrff::BCWAV::Encoding>(
                                    (ctrff::BCWAV::Encoding)b.Encoding,
                                    ctrff::BCWAV::Encoding2String)));
...
static InspectorBCWAV::TabEntry::Ref MakeDspAdpcmParam(
    ctrff::BCWAV::DSP_ADPCM_Param& b, const std::string& name = "") {
  auto e = InspectorBCWAV::TabEntry::New();
  std::vector<InspectorBCWAV::TabEntry::Ref> Lst;
...
static InspectorBCWAV::TabEntry::Ref MakeDspAdpcmContext(
    ctrff::BCWAV::DSP_ADPCM_Context& b, const std::string& name = "") {
  auto e = InspectorBCWAV::TabEntry::New();
  std::vector<InspectorBCWAV::TabEntry::Ref> Lst;
...
static InspectorBCWAV::TabEntry::Ref MakeDspAdpcmInfo(
    ctrff::BCWAV::DSP_ADPCM_Info& b, const std::string& name = "") {
  auto e = InspectorBCWAV::TabEntry::New();
  std::vector<InspectorBCWAV::TabEntry::Ref> Lst;
...
static InspectorBCWAV::TabEntry::Ref MakeDspAdpcmInfoList(
    std::vector<ctrff::BCWAV::DSP_ADPCM_Info>& b,
    const std::string& name = "") {
  auto e = InspectorBCWAV::TabEntry::New();
  std::vector<InspectorBCWAV::TabEntry::Ref> Lst;
  for (size_t i = 0; i < b.size(); i++) {
...
static InspectorBCWAV::TabEntry::Ref MakeHeader(ctrff::BCWAV& b) {
  auto e = InspectorBCWAV::TabEntry::New();
  std::vector<InspectorBCWAV::TabEntry::Ref> Lst;
  Lst.push_back(_me("Magic", MagicStr(b.pHeader.Magic)));
  Lst.push_back(
      _me("Endianness", _fStr<ctrff::BCWAV::Endianness>(
                            (ctrff::BCWAV::Endianness)b.pHeader.Endianness,
                            ctrff::BCWAV::Endianness2String)));
...
void InspectorBCWAV::ReadFile(const std::string& path) {
  List.clear();
  pPath = path;
  ctrff::BCWAV b;
  b.LoadFile(path);
...
InspectorBCWAV::TabEntry::Ref InspectorBCWAV::MakeEntry(
